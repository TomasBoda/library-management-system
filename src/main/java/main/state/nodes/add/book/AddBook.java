...
public class AddBook extends ActionState {
    ...
    public AddBook(String command, String message) {
    ...
    public AddBook(String command, String message, State[] children) {
    ...
    public void execute() {
        ...
        Response response = App.api.books().add(new Book(title, description, author));
